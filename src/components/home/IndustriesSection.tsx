...
export function IndustriesSection() {
  return (
    <section id="industries" className="py-12 bg-[#14141c]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollReveal direction="up">
          <div className="w-full lg:max-w-[75%] mb-8">
            <span className="section-tag">Industries we serve</span>
            <h2 className="font-display text-[30px] lg:text-[40px] font-bold text-white tracking-tight leading-tight mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-4">
          {industriesData.map((item, index) => (
            <ScrollReveal key={item.id} direction="up" delay={index * 0.1}>
              <div className="industry-item h-75">
                <div className="flip-card">
                  <div className="flip-card-inner">
                    <div className="flip-card-front">
                      <div className="icon-square w-[200] h-[150] flex items-center justify-center">
                        <Image
                          src={item.image}
                          alt={item.title}
                          width={200}
